...
## 1. Создали файл для запуска основного terraform кода main.tf, содежащего создание объектов облака AWS и EKS кластер Kubernetes
...
## 4. Создали файл deployment-skruhlik-app.yml
